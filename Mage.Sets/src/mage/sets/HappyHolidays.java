...
public class HappyHolidays extends ExpansionSet {
    ...
    private HappyHolidays() {
        ...
        cards.add(new SetCardInfo("Grimlock, Dinobot Leader", 1, Rarity.MYTHIC, mage.cards.g.GrimlockDinobotLeader.class));
        cards.add(new SetCardInfo("Grimlock, Ferocious King", 1, Rarity.MYTHIC, mage.cards.g.GrimlockFerociousKing.class));
